module.exports = {
    ...
    badUpdateProductData: [
        {
            category_id: 16,
            title: 'Updated Test Product 1(bad)',
            content: 'Updated Test Product Description 1',
            price: 100,
            old_price: 90,
            status: 1,
        ...
        {
            category_id: 0,
            title: 'Updated Test Product 2(bad)',
        ...
        {
            category_id: 0,
            title: 'Updated Test Product 3(bad)',
            content: 'Updated Test Product Description 3',
            price: 1001,
            old_price: 3,
            status: 1,
        ...
        {
            category_id: 0,
            title: 'Updated Test Product 4(bad)',
            content: 'Updated Test Product Description 4',
            price: 1001,
            old_price: 3,
            status: 1,
            keywords: 'badupdated, test, product',
            description: 'Test product for testing purposes 4',
            hit: 10
        },
    ]
}